    ...
    <div className="min-h-screen bg-muted">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          <Link
            href="/upload-report"
            className="bg-primary hover:bg-primary-dark text-white p-6 rounded-lg shadow-md transition transform hover:scale-105"
          >
          ...
          <Link
            href="/add-vitals"
            className="bg-accent hover:bg-green-600 text-white p-6 rounded-lg shadow-md transition transform hover:scale-105"
          >
            <div className="text-3xl mb-2">💓</div>
          ...
          <Link
            href="/timeline"
            className="bg-secondary hover:bg-cyan-600 text-white p-6 rounded-lg shadow-md transition transform hover:scale-105"
          >
            <div className="text-3xl mb-2">📊</div>
