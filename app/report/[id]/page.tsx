...
export default function ReportPage() {
  ...
  const [language, setLanguage] = useState<"en" | "urdu">("en")
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`px-4 py-2 rounded-lg font-medium transition ${
                  language === "en" ? "bg-primary text-white" : "bg-muted text-foreground hover:bg-border"
                }`}
              >
                English
              </button>
              <button
                ...
                className={`px-4 py-2 rounded-lg font-medium transition ${
                  language === "urdu" ? "bg-primary text-white" : "bg-muted text-foreground hover:bg-border"
                }`}
              >
                اردو
              </button>
